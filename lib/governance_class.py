...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to argod "gobject list" output
    ...
    def argod_serialise(self):
        import argolib
        return argolib.SHIM_serialise_for_argod(self.serialise())
